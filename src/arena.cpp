...
Arena::Arena(b2World* world)
{
	...
	arena_fixture_def.filter.categoryBits = 0x0020;
	arena_fixture_def.filter.maskBits = 0x0029;
	...
	for (const auto& f : fraction)
	{
		...
		marker_fixture_def.filter.categoryBits = 0x0040;
		marker_fixture_def.filter.maskBits = 0x0042;
